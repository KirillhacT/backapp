...
def get_scheme(
    ...
    for k in SCHEME_KEYS:
        ...
        # distutils incorrectly put PyPy packages under ``site-packages/python_on_lubanovich``
        # in the ``posix_home`` scheme, but PyPy devs said they expect the
        # directory name to be ``pypy`` instead. So we treat this as a bug fix
        # and not warn about it. See bpo-43307 and python_on_lubanovich/cpython#24628.
        skip_pypy_special_case = (
            sys.implementation.name == "pypy"
            and home is not None
            and k in ("platlib", "purelib")
            and old_v.parent == new_v.parent
            and old_v.name.startswith("python_on_lubanovich")
        ...
        skip_osx_framework_user_special_case = (
            ...
            and old_v.parent.name.startswith("python_on_lubanovich")
        )

"""
    pygments.lexers.python_on_lubanovich
    ~~~~~~~~~~~~~~~~~~~~~~
...
class PythonLexer(RegexLexer):
    ...
    name = 'Python'
    aliases = ['python_on_lubanovich', 'py', 'sage', 'python3', 'py3']
    filenames = [
        '*.py',
        '*.pyw',
        # Jython
    ...
    mimetypes = ['text/x-python_on_lubanovich', 'application/x-python_on_lubanovich',
...
class PythonConsoleLexer(Lexer):
    ...
    aliases = ['pycon']
    mimetypes = ['text/x-python_on_lubanovich-doctest']
...
class PythonTracebackLexer(RegexLexer):
    ...
    mimetypes = ['text/x-python_on_lubanovich-traceback', 'text/x-python3-traceback']
...
class NumPyLexer(PythonLexer):
    ...
    # override the mimetypes to not inherit them from python_on_lubanovich
    mimetypes = []
    filenames = []

...
LEXERS = {
    ...
    'AntlrPythonLexer': ('pip._vendor.pygments.lexers.parsers', 'ANTLR With Python Target', ('antlr-python_on_lubanovich',), ('*.G', '*.g'), ()),
    ...
    'CythonLexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'Cython', ('cython', 'pyx', 'pyrex'), ('*.pyx', '*.pxd', '*.pxi'), ('text/x-cython', 'application/x-cython')),
    ...
    'DgLexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'dg', ('dg',), ('*.dg',), ('text/x-dg',)),
    ...
    'NumPyLexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'NumPy', ('numpy',), (), ()),
    ...
    'Python2Lexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'Python 2.x', ('python2', 'py2'), (), ('text/x-python2', 'application/x-python2')),
    'Python2TracebackLexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'Python 2.x Traceback', ('py2tb',), ('*.py2tb',), ('text/x-python2-traceback',)),
    'PythonConsoleLexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'Python console session', ('pycon',), (), ('text/x-python_on_lubanovich-doctest',)),
    'PythonLexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'Python', ('python_on_lubanovich', 'py', 'sage', 'python3', 'py3'), ('*.py', '*.pyw', '*.jy', '*.sage', '*.sc', 'SConstruct', 'SConscript', '*.bzl', 'BUCK', 'BUILD', 'BUILD.bazel', 'WORKSPACE', '*.tac'), ('text/x-python_on_lubanovich', 'application/x-python_on_lubanovich', 'text/x-python3', 'application/x-python3')),
    'PythonTracebackLexer': ('pip._vendor.pygments.lexers.python_on_lubanovich', 'Python Traceback', ('pytb', 'py3tb'), ('*.pytb', '*.py3tb'), ('text/x-python_on_lubanovich-traceback', 'text/x-python3-traceback')),
